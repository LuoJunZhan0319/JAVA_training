...
public class FinalExam extends GradedActivity             //extends ´N¬OÄ~©Ó!!!
{
   ...
   */
   ...
   public FinalExam(int questions, int missed)
   {
      ...
      numQuestions = questions;							// 20
      numMissed = missed;								// 5

      // Calculate the points for each question and
      // the numeric score for this exam.
      pointsEach = 100.0 / questions;					// 5
      numericScore = 100.0 - (missed * pointsEach);		// 75
