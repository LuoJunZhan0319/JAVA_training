...
public class Board_Q4 extends JPanel {
    ...
    private boolean a = false,b = false,c = false,d = false;						//設定幸運記號
    private boolean luckywin = false;				//設定幸運通關的鑰匙

    //建構式
    public Board_Q4(JLabel statusbar) {
    	//執行父類別(JPanel)
    	super();
    	//設定物件參數
    ...
    public void paintComponent(Graphics g) {
    	...
    	//幸運判斷
    	if(a == true && b == true && c == true && d == true && inGame == true ) 
    	{
        	luckywin = true;
        }
        ...
        }else if (luckywin == true)
        {
        	inGame = false;
            statusbar.setText("Lucky win!!");
        }
        //失敗條件
        else if (!inGame) {
            ...
            if ((x < N_COLS * CELL_SIZE) && (y < N_ROWS * CELL_SIZE)) {		//確定未超出視窗邊界
                ...
                //如果不是按滑鼠右鍵
                    ...
                    if ((field[(cRow * N_COLS) + cCol] > MINE_CELL)
                        ...
                        else if(cCol == 1 && cRow == 0 && a == true)
                        {
                        	
                        	b = true;
                        	doRepaint = true;
                    	}
                        else if(cCol == 2 && cRow == 0 && a == true && b == true)
                        {
                        	
                        	c = true;
                        	doRepaint = true;
                    	}
                        else if(cCol == 3 && cRow == 0 && a == true && b == true && c == true)
                        {
